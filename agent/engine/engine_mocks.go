...
func (_m *MockDockerClient) RemoveImageExtended(_param0 string, _param1 go_dockerclient.RemoveImageOptions) error {
	ret := _m.ctrl.Call(_m, "RemoveImageExtended", _param0, _param1)
	ret0, _ := ret[0].(error)
	return ret0
}

func (_mr *_MockDockerClientRecorder) RemoveImageExtended(arg0, arg1 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "RemoveImageExtended", arg0, arg1)
}
